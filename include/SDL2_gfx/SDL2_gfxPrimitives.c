...
*/
int pixel(SDL_Renderer *renderer, const Sint16 x, const Sint16 y) {
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, Uint32 color) {
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    int result = 0;
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelRGBAWeight(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Uint8 r, const Uint8 g, const Uint8 b, Uint8 a, const Uint32 weight) {
    /*
...
\returns Returns 0 on success, -1 on failure.
*/
int hline(SDL_Renderer *renderer, const Sint16 x1, const Sint16 x2, const Sint16 y) {
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineColor(SDL_Renderer *renderer, const Sint16 x1, const Sint16 x2, const Sint16 y, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineRGBA(SDL_Renderer *renderer, const Sint16 x1, const Sint16 x2, const Sint16 y, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    int result = 0;
    result |= SDL_SetRenderDrawBlendMode(renderer, a == 255 ? SDL_BLENDMODE_NONE : SDL_BLENDMODE_BLEND);
    result |= SDL_SetRenderDrawColor(renderer, r, g, b, a);
...
\returns Returns 0 on success, -1 on failure.
*/
int vline(SDL_Renderer *renderer, const Sint16 x, const Sint16 y1, const Sint16 y2) {
...
\returns Returns 0 on success, -1 on failure.
*/
int vlineColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y1, const Sint16 y2, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int vlineRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y1, const Sint16 y2, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    int result = 0;
    result |= SDL_SetRenderDrawBlendMode(renderer, a == 255 ? SDL_BLENDMODE_NONE : SDL_BLENDMODE_BLEND);
    result |= SDL_SetRenderDrawColor(renderer, r, g, b, a);
...
\returns Returns 0 on success, -1 on failure.
*/
int rectangleColor(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
int roundedRectangleRGBA(
    ...
    */
    const Sint16 w = x2 - x1;
    const Sint16 h = y2 - y1;
    ...
    * Draw corners
    */
    const Sint16 xx1 = x1 + rad;
    const Sint16 xx2 = x2 - rad;
    const Sint16 yy1 = y1 + rad;
    const Sint16 yy2 = y2 - rad;
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedBoxColor(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, const Sint16 rad, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
int roundedBoxRGBA(
    ...
    * Calculate width&height
    */
    const Sint16 w = x2 - x1 + 1;
    const Sint16 h = y2 - y1 + 1;
    ...
    */
    ...
    const Sint16 x = x1 + rad;
    const Sint16 y = y1 + rad;
    const Sint16 dx = x2 - x1 - rad - rad;
    const Sint16 dy = y2 - y1 - rad - rad;
    ...
    */
    do {
        const Sint16 xpcx = x + cx;
        const Sint16 xmcx = x - cx;
        const Sint16 xpcy = x + cy;
        const Sint16 xmcy = x - cy;
        if (ocy != cy) {
            if (cy > 0) {
                const Sint16 ypcy = y + cy;
                const Sint16 ymcy = y - cy;
        ...
        if (ocx != cx) {
            if (cx != cy) {
                if (cx > 0) {
                    const Sint16 ypcx = y + cx;
                    const Sint16 ymcx = y - cx;
...
\returns Returns 0 on success, -1 on failure.
*/
int boxColor(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int boxRGBA(SDL_Renderer *renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    Sint16 tmp;
    SDL_Rect rect;
...
\returns Returns 0 on success, -1 on failure.
*/
int line(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2) {
    /*
    * Draw
    */
...
\returns Returns 0 on success, -1 on failure.
*/
int lineColor(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int lineRGBA(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    /*
    * Draw
    */
    int result = 0;
...
int aalineRGBA_(
    ...
    */
    const Uint32 intshift = 32 - AAbits;

    // /*
    // * Mask used to flip all bits in an intensity weighting
    // */
    // Uint32 wgtcompmask = AAlevels - 1;
...
\returns Returns 0 on success, -1 on failure.
*/
int aalineColor(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
    return aalineRGBA_(renderer, x1, y1, x2, y2, c[0], c[1], c[2], c[3], 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aalineRGBA(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    return aalineRGBA_(renderer, x1, y1, x2, y2, r, g, b, a, 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int circleColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int circleRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
...
\returns Returns 0 on success, -1 on failure.
*/
int arcColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, const Sint16 start, const Sint16 end, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    /*
    * Draw
    */
...
\returns Returns 0 on success, -1 on failure.
*/
int drawQuadrants(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 dx, const Sint16 dy, const Sint32 f) {
    int result = 0;
    Sint16 ypdy, ymdy;
    ...
    if (dx == 0) {
        ...
        const Sint16 xpdx = x + dx;
        const Sint16 xmdx = x - dx;
        ypdy = y + dy;
        ymdy = y - dy;
        if (f) {
...
int ellipseRGBA_(
    ...
    */
     ...
     */
    Sint32 oldX = scrX = 0;
    Sint32 oldY = scrY = ryi;
    result |= drawQuadrants(renderer, x, y, 0, ry, f);

    /* Midpoint ellipse algorithm with overdraw */
    rxi *= ellipseOverscan;
    ryi *= ellipseOverscan;
    const Sint32 rx2 = rxi * rxi;
    const Sint32 rx22 = rx2 + rx2;
    const Sint32 ry2 = ryi * ryi;
    const Sint32 ry22 = ry2 + ry2;
    Sint32 curX = 0;
    Sint32 curY = ryi;
    Sint32 deltaX = 0;
    Sint32 deltaY = rx22 * curY;

    /* Points in segment 1 */
    Sint32 error = ry2 - rx2 * ryi + rx2 / 4;
    while (deltaX <= deltaY) {
        curX++;
        deltaX += ry22;
        ...
        if ((scrX != oldX && scrY == oldY) || (scrX != oldX && scrY != oldY)) {
            result |= drawQuadrants(renderer, x, y, scrX, scrY, f);
            oldX = scrX;
            oldY = scrY;
        }
    }
    ...
    /* Points in segment 2 */
    if (curY > 0) {
        const Sint32 curXp1 = curX + 1;
        const Sint32 curYm1 = curY - 1;
        ...
        while (curY > 0) {
            ...
            if ((scrX != oldX && scrY == oldY) || (scrX != oldX && scrY != oldY)) {
                oldY--;
                for (; oldY >= scrY; oldY--) {
                    result |= drawQuadrants(renderer, x, y, scrX, oldY, f);
                    /* prevent overdraw */
                    if (f) {
                        oldY = scrY - 1;
                    }
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rx, const Sint16 ry, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
    return ellipseRGBA_(renderer, x, y, rx, ry, c[0], c[1], c[2], c[3], 0);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rx, const Sint16 ry, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    return ellipseRGBA_(renderer, x, y, rx, ry, r, g, b, a, 0);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    return ellipseRGBA_(renderer, x, y, rad, rad, r, g, b, a, 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aaellipseColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rx, const Sint16 ry, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int filledEllipseColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rx, const Sint16 ry, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
    return ellipseRGBA_(renderer, x, y, rx, ry, c[0], c[1], c[2], c[3], 1);
}
...
int filledEllipseRGBA(
    ...
    return ellipseRGBA_(renderer, x, y, rx, ry, r, g, b, a, 1);
}
...
int pieRGBA_(
    ...
    */
    ...
    const double start_angle = (double)start * (2.0 * M_PI / 360.0);
    double end_angle = (double)end * (2.0 * M_PI / 360.0);
    if (start > end) {
        end_angle += 2.0 * M_PI;
    }
    ...
    Sint16 *vx = vy = (Sint16 *)malloc(2 * sizeof(Uint16) * numpoints);
    if (vx == NULL) {
        return -1;
    }
...
int pieColor(
    ...
    const Uint8 *c = (Uint8 *)&color;
    return pieRGBA_(renderer, x, y, rad, start, end, c[0], c[1], c[2], c[3], 0);
}
...
int pieRGBA(
    ...
    return pieRGBA_(renderer, x, y, rad, start, end, r, g, b, a, 0);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPieColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const Sint16 rad, const Sint16 start, const Sint16 end, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
    return pieRGBA_(renderer, x, y, rad, start, end, c[0], c[1], c[2], c[3], 1);
}
...
int filledPieRGBA(
    ...
    return pieRGBA_(renderer, x, y, rad, start, end, r, g, b, a, 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int polygonColor(SDL_Renderer *renderer, const Sint16 *vx, const Sint16 *vy, const int n, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int polygon(SDL_Renderer *renderer, const Sint16 *vx, const Sint16 *vy, const int n) {
    /*
    * Draw
    */
    int result = 0;
    ...
    */
    const int nn = n + 1;
    SDL_Point *points = malloc(sizeof(SDL_Point) * nn);
    if (points == NULL) {
        return -1;
    }
    for (int i = 0; i < n; i++) {
...
\returns Returns 0 on success, -1 on failure.
*/
int polygonRGBA(SDL_Renderer *renderer, const Sint16 *vx, const Sint16 *vy, const int n, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    /*
    * Draw
    */
...
\returns Returns 0 on success, -1 on failure.
*/
int aapolygonColor(SDL_Renderer *renderer, const Sint16 *vx, const Sint16 *vy, const int n, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
int aapolygonRGBA(
    ...
    * Pointer setup
    */
    const Sint16 *x1 = x2 = vx;
    const Sint16 *y1 = y2 = vy;
    x2++;
    y2++;
    ...
    */
    int result = 0;
    for (int i = 1; i < n; i++) {
        result |= aalineRGBA_(renderer, *x1, *y1, *x2, *y2, r, g, b, a, 0);
        x1 = x2;
        y1 = y2;
        x2++;
        y2++;
    ...
    result |= aalineRGBA_(renderer, *x1, *y1, *vx, *vy, r, g, b, a, 0);
    ...
    */
    ...
    for (int y = miny; y <= maxy; y++) {
        ...
        */
        ...
        for (i = 0; i < ints; i += 2) {
            int xa = gfxPrimitivesPolyInts[i] + 1;
            xa = (xa >> 16) + ((xa & 32768) >> 15);
            int xb = gfxPrimitivesPolyInts[i + 1] - 1;
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonColor(SDL_Renderer *renderer, const Sint16 *vx, const Sint16 *vy, const int n, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
int HLineTextured(
    ...
    const int texture_w,
    const int texture_h,
    const int texture_dx,
    const int texture_dy
) {
    int result = 0;
    ...
    */
    int texture_x_walker = (x1 - texture_dx) % texture_w;
    if (texture_x_walker < 0) {
        texture_x_walker = texture_w + texture_x_walker;
    }

    int texture_y_start = (y + texture_dy) % texture_h;
    ...
    if (w <= texture_w - texture_x_walker) {
        ...
        int pixels_written = texture_w - texture_x_walker;
        source_rect.w = pixels_written;
        source_rect.x = texture_x_walker;
        dst_rect.x = x1;
        dst_rect.w = source_rect.w;
        result |= SDL_RenderCopy(renderer, texture, &source_rect, &dst_rect) == 0;
        int write_width = texture_w;
...
*/
void gfxPrimitivesSetFont(const void *fontdata, const Uint32 cw, const Uint32 ch) {
    if (fontdata && cw && ch) {
...
\returns Returns 0 on success, -1 on failure.
*/
int characterRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const char c, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    SDL_Rect srect;
    SDL_Rect drect;
    ...
    */
    ...
    const Uint32 ci = (unsigned char)c;
    ...
    */
    if (gfxPrimitivesFont[ci] == NULL) {
        ...
        */
        SDL_Surface *character = SDL_CreateRGBSurface(
            SDL_SWSURFACE,
            charWidth,
            charHeight,
            32,
        ...
        const unsigned char *charpos = currentFontdata + ci * charSize;
        Uint8 *linepos = character->pixels;
        const Uint32 pitch = character->pitch;
        ...
        */
        ...
        if (charRotation > 0) {
            SDL_Surface *rotatedCharacter = rotateSurface90Degrees(character, charRotation);
...
\returns Returns 0 on success, -1 on failure.
*/
int characterColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const char c, Uint32 color) {
    const Uint8 *co = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int stringColor(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const char *s, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int stringRGBA(SDL_Renderer *renderer, const Sint16 x, const Sint16 y, const char *s, const Uint8 r, const Uint8 g, const Uint8 b, const Uint8 a) {
    int result = 0;
    Sint16 curx = x;
    Sint16 cury = y;
...
*/
double evaluateBezier(const double *data, const int ndata, const double t) {
    /* Sanity check bounds */
    if (t < 0.0) {
        return data[0];
    }
    ...
    const double mu = t / (double)ndata;

    /* Calculate interpolate */
    const int n = ndata - 1;
    double result = 0.0;
    double muk = 1;
    double munk = pow(1 - mu, n);
    for (int k = 0; k <= n; k++) {
        int nn = n;
        int kn = k;
        int nkn = n - k;
...
\returns Returns 0 on success, -1 on failure.
*/
int bezierColor(SDL_Renderer *renderer, const Sint16 *vx, const Sint16 *vy, const int n, const int s, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
int bezierRGBA(
    ...
    * Variable setup
    */
    const double stepsize = 1.0 / (double)s;
    ...
    */
    double t = 0.0;
    Sint16 x1 = lrint(evaluateBezier(x, n + 1, t));
    Sint16 y1 = lrint(evaluateBezier(y, n + 1, t));
    for (i = 0; i <= n * s; i++) {
        t += stepsize;
        const Sint16 x2 = (Sint16)evaluateBezier(x, n, t);
        const Sint16 y2 = (Sint16)evaluateBezier(y, n, t);
...
\returns Returns 0 on success, -1 on failure.
*/
int thickLineColor(SDL_Renderer *renderer, const Sint16 x1, const Sint16 y1, const Sint16 x2, const Sint16 y2, const Uint8 width, Uint32 color) {
    const Uint8 *c = (Uint8 *)&color;
...
int thickLineRGBA(
    ...
    const double l = SDL_sqrt(dx * dx + dy * dy);
    const double ang = SDL_atan2(dx, dy);
    const double adj = 0.1 + 0.9 * SDL_fabs(SDL_cos(2.0 * ang));
    const double wl2 = ((double)width - adj) / (2.0 * l);
